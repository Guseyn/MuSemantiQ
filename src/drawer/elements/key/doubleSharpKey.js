...
key signature the language can write contains a double sharp. The accidental on a
*note* takes a different road: keysForCurrentCrossStaveUnit.js imports
doubleSharpKeyShape.js directly, which is why the shape beside this file is fully
