 ...
 * re-exported here. A page that only highlights text imports them from there
 * and loads the language alone, without the drawer, the fonts or the MIDI
 * engine that the rest of this file pulls in.
 */
export {
 ...
 *   pageSchema,
 *   customStyles
 * } = generateIntermediateStructuresForSinglePage({ pageText, supportedFontNames: fonts })
 *
 * const pageStyles = generateStylesForSinglePage({
 *   customStyles,
 *   supportedFontSources: fonts
